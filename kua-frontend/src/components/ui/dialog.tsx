...
>(({ className, children, ...props }, ref) => (
  <DialogPortal>
    ...
    >
      {children}
      <DialogPrimitive.Close className="absolute right-4 top-4 rounded-md border border-border/60 bg-card/60 p-1.5 text-muted-foreground transition hover:text-foreground hover:border-primary/40 focus:outline-none">
