...
>(({ className, ...props }, ref) => (
  <SwitchPrimitives.Root
    ...
    className={cn(
      ...
      "data-[state=checked]:bg-primary/20 data-[state=checked]:border-primary/60",
  ...
  >
    <SwitchPrimitives.Thumb
      className={cn(
        "pointer-events-none block h-3.5 w-3.5 rounded-full bg-foreground/70 shadow-lg ring-0 transition-transform",
